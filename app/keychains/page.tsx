export default function KeychainsPage() {
  const products = [
    { name: "Acrylic Name Keychain", price: "$12.00", available: true },
    { name: "Tassel Keychain", price: "$10.00", available: true },
    { name: "Photo Keychain", price: "$14.00", available: true },
    { name: "Resin Shaker Keychain", price: "$16.00", available: false },
    { name: "Leather Key Fob", price: "$12.00", available: true },
    { name: "Mini Cup Keychain", price: "$15.00", available: true },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#fff8fb] text-[#24151b]">
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        ...
        <h1 className="text-5xl font-black md:text-6xl">Keychains</h1>
