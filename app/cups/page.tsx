const cupCategories = [
  {
    title: "Snowglobe Tumblers",
    description:
      "Custom snowglobe tumblers made with your choice of colors, glitter, wraps, and personalized details.",
  ...
  },
  {
    title: "Glass Cans",
    description:
      "Personalized glass cups featuring custom designs, decals, wraps, and matching accessories.",
    price: "Message for pricing",
    icon: "🥤",
  },
  {
    ...
    description:
      "Choose your cup style and design to create a personalized tumbler made especially for you.",
    price: "Message for pricing",
    icon: "🎀",
  },
];
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-red-900/80 bg-black/85 p-6 text-center shadow-2xl backdrop-blur-md sm:p-10 md:p-12">
            ...
            <p
              ...
              style={smokyTextShadow}
            >
              Browse our custom tumblers, snowglobe cups, glass cans, and
              personalized drinkware made by Pressed In Pink.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-20 sm:px-6">
          <div className="mx-auto max-w-3xl rounded-[2rem] border border-red-900 bg-black/90 p-7 text-center shadow-xl backdrop-blur-md sm:p-10">
            ...
            <p
              ...
              style={smokyTextShadow}
            >
              Choose your cup style, then send us the colors, theme, character,
              team, photo, or wrap you would like us to use.
            </p>
