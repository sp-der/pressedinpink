export default function CupsPage() {
  const products = [
    { name: "Snowglobe Tumbler", price: "$35.00", available: true },
    { name: "Glass Can Cup", price: "$25.00", available: true },
    { name: "Custom Tumbler 20oz", price: "$40.00", available: true },
    { name: "Kids Tumbler", price: "$30.00", available: false },
    { name: "Wine Tumbler", price: "$28.00", available: true },
    { name: "Coffee Mug", price: "$22.00", available: true },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#fff8fb] text-[#24151b]">
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        ...
        <h1 className="text-5xl font-black md:text-6xl">Cups</h1>
