...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  const filename = `bulls (${number})`;

  return {
    number,
    src: `${R2_WRAP_BASE_URL}/bulls/originals/${filename}.png`,
    thumbnailSrc:
      `${R2_WRAP_BASE_URL}/bulls/thumbnails/${filename}.webp`,
  };
});
  ...
  const renderPagination = (
    ...
    return (
      <div
        ...
        aria-label={`Chicago Bulls wrap gallery ${location} pages`}
      >
        <button
          type="button"
