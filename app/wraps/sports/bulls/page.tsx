...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  return {
    number,
    src: `/wraps/bulls/bulls (${number}).png`,
    thumbnailSrc: `/wraps/bulls/thumbnails/bulls (${number}).webp`,
  };
});
    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        >
          <div className="mb-7 flex flex-col items-center justify-between gap-4 rounded-2xl border border-red-900/80 bg-black/80 px-5 py-4 backdrop-blur-md sm:flex-row">
            ...
            <div
              ...
              aria-label="Chicago Bulls wrap gallery pages"
            >
              <button
                type="button"
            ...
            {visibleWraps.map((wrap, localIndex) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Open chicago bulls wrap ${wrap.number}`}
                ...
                >
                  <div className="relative aspect-[2/1] w-full overflow-hidden">
                    <img
                      ...
                      alt={`Chicago Bulls wrap design ${wrap.number}`}
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <div
              className="flex flex-wrap items-center justify-center gap-2"
              aria-label="Chicago Bulls wrap gallery bottom pages"
            >
              <button
                type="button"
                onClick={() => goToPage(currentPage - 1)}
      ...
      {selectedIndex !== null && (
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Chicago Bulls wrap image viewer"
        ...
        >
          ...
          <button
            ...
            aria-label="Previous chicago bulls wrap"
          ...
          >
            <div className="relative aspect-[2/1] w-full overflow-hidden rounded-2xl bg-white">
              <img
                ...
                alt={`Chicago Bulls wrap design ${wraps[selectedIndex].number}`}
                draggable={false}
                className="
                  absolute left-1/2 top-1/2
          ...
          <button
            ...
            aria-label="Next chicago bulls wrap"
