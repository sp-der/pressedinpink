...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  const filename = `celtics (${number})`;

  return {
    number,
    src: `${R2_WRAP_BASE_URL}/celtics/originals/${filename}.png`,
    thumbnailSrc:
      `${R2_WRAP_BASE_URL}/celtics/thumbnails/${filename}.webp`,
  };
});
  ...
  const renderPagination = (
    ...
    return (
      <div
        ...
        aria-label={`Boston Celtics wrap gallery ${location} pages`}
      >
        <button
          type="button"
