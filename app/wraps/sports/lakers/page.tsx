...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  return {
    number,
    src: `/wraps/lakers/lakers (${number}).png`,
    thumbnailSrc: `/wraps/lakers/thumbnails/lakers (${number}).webp`,
  };
});
    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-red-900/80 bg-black/85 p-7 text-center shadow-2xl backdrop-blur-md sm:p-10">
            ...
            <p
              ...
              style={smokyTextShadow}
            >
              Click any design to see the full wrap. Use the gallery pages to browse faster, or use the viewer arrows to move through all 14 designs continuously.
            </p>
          </div>
        </section>
        ...
        >
          <div className="mb-7 flex flex-col items-center justify-between gap-4 rounded-2xl border border-red-900/80 bg-black/80 px-5 py-4 backdrop-blur-md sm:flex-row">
            ...
            <div
              ...
              aria-label="Los Angeles Lakers wrap gallery pages"
            >
              <button
                type="button"
            ...
            {visibleWraps.map((wrap, localIndex) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Open los angeles lakers wrap ${wrap.number}`}
                ...
                >
                  <div className="relative aspect-[2/1] w-full overflow-hidden">
                    <img
                      ...
                      alt={`Los Angeles Lakers wrap design ${wrap.number}`}
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            ...
            <div
              className="flex flex-wrap items-center justify-center gap-2"
              aria-label="Los Angeles Lakers wrap gallery bottom pages"
            >
              <button
                type="button"
                onClick={() => goToPage(currentPage - 1)}
      ...
      {selectedIndex !== null && (
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Los Angeles Lakers wrap image viewer"
        ...
        >
          ...
          <button
            ...
            aria-label="Previous los angeles lakers wrap"
          ...
          >
            <div className="relative aspect-[2/1] w-full overflow-hidden rounded-2xl bg-white">
              <img
                ...
                alt={`Los Angeles Lakers wrap design ${wraps[selectedIndex].number}`}
                draggable={false}
                className="
                  absolute left-1/2 top-1/2
          ...
          <button
            ...
            aria-label="Next los angeles lakers wrap"
