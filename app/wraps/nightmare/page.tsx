...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  const filename = `nightmare (${number})`;

  return {
    number,
    src: `${R2_WRAP_BASE_URL}/nightmare/originals/${filename}.png`,
    thumbnailSrc:
      `${R2_WRAP_BASE_URL}/nightmare/thumbnails/${filename}.webp`,
  };
});
  ...
  const renderPagination = (
    ...
    return (
      <div
        ...
        aria-label={`Nightmare Before Christmas wrap gallery ${location} pages`}
      >
        <button
          type="button"
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-red-900/80 bg-black/85 p-7 text-center shadow-2xl backdrop-blur-md sm:p-10">
            ...
            >
              ...
              arrows to move through all 48 designs continuously.
            </p>
          </div>
        </section>
