...
const wraps = Array.from({ length: TOTAL_IMAGES }, (_, index) => {
  ...
  const filename = `420 (${number})`;

  return {
    number,
    src: `${R2_WRAP_BASE_URL}/420/originals/${filename}.png`,
    thumbnailSrc:
      `${R2_WRAP_BASE_URL}/420/thumbnails/${filename}.webp`,
  };
});
  ...
  const renderPagination = (
    ...
    return (
      <div
        ...
        aria-label={`420 wrap gallery ${location} pages`}
      >
        <button
          type="button"
    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-red-900/80 bg-black/85 p-7 text-center shadow-2xl backdrop-blur-md sm:p-10">
            ...
            >
              ...
              arrows to move through all 15 designs continuously.
            </p>
          </div>
        </section>
            ...
            {visibleWraps.map((wrap, localIndex) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Open 420 wrap ${wrap.number}`}
                ...
                >
                  <div className="relative aspect-[2/1] w-full overflow-hidden">
                    <img
                      ...
                      alt={`420 wrap design ${wrap.number}`}
                      loading={
                        localIndex < 3
                          ? "eager"
                          : "lazy"
      ...
      {selectedIndex !== null && (
        <div
          role="dialog"
          aria-modal="true"
          aria-label="420 wrap image viewer"
          ...
          >
            <div className="relative aspect-[2/1] w-full overflow-hidden rounded-2xl bg-white">
              <img
                ...
                alt={`420 wrap design ${wraps[selectedIndex].number}`}
                draggable={false}
                className="
                  absolute left-1/2 top-1/2
